...
class MLLMTemplateType:
    qwen3_vl_llava_baseline = 'qwen3_vl_llava_baseline'
    qwen_vl = 'qwen_vl'
    ...
    duplex_forward_visual_tokens_arch = 'duplex_forward_visual_tokens_arch'
    minicpmv4_5_duplex = 'minicpmv4_5_duplex'
